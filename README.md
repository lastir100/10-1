# Домашнее задание к занятию 1 «Disaster recovery и Keepalived» - Минин Александр
...
Итоговая [схема](./files/hsrp_advanced_minin.pkt) в формате pkt

Процесс настройки маршрутизаторов:
![config](./img/task1.jpg)
